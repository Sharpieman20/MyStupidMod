...
//    private static Logger LOGGER;
    ...
    private void injected(ChunkBuilder.BuiltChunk.RebuildTask rebuildTask, Object x) {
    ...
    private void injected2(ChunkBuilder.BuiltChunk.RebuildTask rebuildTask, Object x) {

        myCodeInner();
    }

    @Redirect(method = "cancel()V", at = @At(value = "FIELD", target = targetString, opcode = Opcodes.PUTFIELD))
    private void injected3(ChunkBuilder.BuiltChunk.RebuildTask rebuildTask, Object x) {
